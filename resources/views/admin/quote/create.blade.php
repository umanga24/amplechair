                ...
                <div class="card-body">
                    ...
                    <form action="/quote" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input id="quote_title" class="form-control" type="text" name="quote_title" placeholder="enter quote_title">
                        </div>

                        <div class="form-group">
                            <label for="quote_description">Quote_Description</label>
                            <textarea id="description" class="form-control" name="quote_description" rows="3" placeholder="enter quote description"></textarea>
                        </div>
