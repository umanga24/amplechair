...
<script>
    ...
    $(document).ready(function(){
        $('#sortable').sortable({
            stop:function(){
                $.map($(this).find('tr'), function(element){
                    console.log($(this));
                    var id = element.id;
