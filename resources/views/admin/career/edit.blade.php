        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                      <h1>Career</h1>
                    <a href="/position" class="float-end btn btn-info">Back</a>
                ...
                <div class="card-body">
                    ...
                    <form action="/position/{{$position->id}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input id="post_title" class="form-control" type="text" name="post_title" placeholder="enter post_title" value="{{$position->post_title}}">
                        </div>

                        <div class="form-group">
                            <label for="post_description">Equirements</label>
                            <textarea id="description" class="form-control" name="post_description" rows="3"  >{!!$position->post_description!!}</textarea>
                        </div>
