        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="/operation/{{$operation->id}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('put')

                        <div class="form-group">
                            <label for="process_title">Process_title</label>
                            <input id="process_title" class="form-control" type="text" name="process_title" value="{{$operation->process_title}}" placeholder="enter process_title">
                        </div>

                 <div class="form-group">
                    <label for="process_description">Description</label>
                    <textarea id="description" class="form-control" name="process_description" rows="3">{!! $operation->process_description!!}</textarea>
                 </div>
                       ...
                       <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="my-2">
                                    <img src="{{asset($operation->process_image)}}" height="120" width="120" alt="">
                                </div>
                                <input id="process_image" class="form-control" type="file" name="process_image" value="process_image" placeholder="enter process_image">
                            </div>
                           </div>
                           ...
                           <!--     </div>-->
                           <!--     <input id="process_banner_image" class="form-control" type="file" name="process_banner_image" value="{{$operation->process_banner_image}}" placeholder="enter process_banner_image">-->
                           <!-- </div>-->
                           <!--</div>-->
