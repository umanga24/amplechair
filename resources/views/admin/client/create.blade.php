                ...
                <div class="card-body">
                    ...
                    <form action="/customer" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="subtitle" class="form-control" name="subtitle" rows="3"></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="my-2">
                                        <img src="{{asset('client_image')}}" alt="">
                                    </div>
                                    <input id="client_image" class="form-control" type="file" name="client_image" placeholder="enter client_image">
                                </div>
                            </div>
                        </div>
