        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <!--<a href="/banner" class="float-end btn btn-info">Banner Edit</a>-->
                       ...
                       <div class="row">
                        <div class="col-md-6">
                         <div class="form-group">
                             ...
                             <input id="client_banner" class="form-control" type="file" accept="image/*" name="client_banner" placeholder="enter image">
                         </div>
